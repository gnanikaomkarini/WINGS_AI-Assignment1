...
/* package requirements-0.1.0.0 */
#ifndef VERSION_requirements
#define VERSION_requirements "0.1.0.0"
#endif /* VERSION_requirements */
#ifndef MIN_VERSION_requirements
#define MIN_VERSION_requirements(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_requirements */
...
#define CURRENT_COMPONENT_ID "requirements-0.1.0.0-inplace-requirements"
